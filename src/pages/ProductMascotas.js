...
import { ProductoElegidoMascotas } from '../utils/api'
            ...
            <div className='product-container'>
                <div className='product-container__desc-content'>
                    ...
                    <div className='desc-content__resume-product'>
                        ...
                        <form>
                          <Link to={`/mascotas/create-checkout-session/id=${productos._id}`}>
...
export default ProductMascotas